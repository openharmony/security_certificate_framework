...
HWTEST_F(CryptoX509CertChainTestPart2, ValidateOpensslBranchTest001, TestSize.Level0)
{
    CF_LOG_I("ValidateOpensslBranchTest001");
    ...
    // test PushCrl2Stack failed case
...
HWTEST_F(CryptoX509CertChainTestPart2, ValidateOpensslRevocationOnLineTest002, TestSize.Level0)
{
    CF_LOG_I("ValidateOpensslRevocationOnLineTest002");
    ASSERT_NE(g_certChainPemSpi163, nullptr);
    ...
    // test CheckCertChainIsRevoked failed case
    CF_LOG_I("ValidateOpensslRevocationOnLineTest002 - 01");
    X509OpensslMock::SetMockFlag(true);
    ...
    CF_LOG_I("ValidateOpensslRevocationOnLineTest002 - 02");
    X509OpensslMock::SetMockFlag(true);
    EXPECT_CALL(X509OpensslMock::GetInstance(), OPENSSL_sk_value(_, _))
...
HWTEST_F(CryptoX509CertChainTestPart2, ValidateOpensslRevocationOnLineTest003, TestSize.Level0)
{
    CF_LOG_I("ValidateOpensslRevocationOnLineTest003");
    ASSERT_NE(g_certChainPemSpi163, nullptr);
...
HWTEST_F(CryptoX509CertChainTestPart2, ValidateOpensslRevocationOnLineTest005, TestSize.Level0)
{
    CF_LOG_I("ValidateOpensslRevocationOnLineTest005");
    ASSERT_NE(g_certChainPemSpi163, nullptr);
    ...
    // test CheckCertChainIsRevoked failed case
    CF_LOG_I("ValidateOpensslRevocationOnLineTest - 1");
    X509OpensslMock::SetMockFlag(true);
    EXPECT_CALL(X509OpensslMock::GetInstance(), OPENSSL_sk_value(_, _))
        .WillOnce(Invoke(__real_OPENSSL_sk_value))
        .WillOnce(Invoke(__real_OPENSSL_sk_value))
    ...
    params.revocationCheckParam->crlDownloadURI = NULL;

    CF_LOG_I("ValidateOpensslRevocationOnLineTest - 2");
    X509OpensslMock::SetMockFlag(true);
    EXPECT_CALL(X509OpensslMock::GetInstance(), OPENSSL_sk_value(_, _))
        .WillOnce(Invoke(__real_OPENSSL_sk_value))
        .WillOnce(Invoke(__real_OPENSSL_sk_value))
