...
// Certificate subjectName contains Chinese and special characters.
HWTEST_F(CryptoX509CertificateTest, getSubjectNameUtf8001, TestSize.Level0)
{
    HcfX509Certificate *x509Cert = nullptr;
    CfEncodingBlob inStream = { 0 };
    ...
    CfBlob out = { 0 };
    ret = x509Cert->getSubjectNameEx(x509Cert, CF_ENCODING_UTF8, &out);
    EXPECT_EQ(ret, CF_SUCCESS);
    EXPECT_NE(out.data, nullptr);
    CfBlobDataClearAndFree(&out);
    CfObjDestroy(x509Cert);
...
// Certificate subjectName is null.
HWTEST_F(CryptoX509CertificateTest, getSubjectNameUtf8002, TestSize.Level0)
{
    HcfX509Certificate *x509Cert = nullptr;
    CfEncodingBlob inStream = { 0 };
...
// invalid input.
HWTEST_F(CryptoX509CertificateTest, getSubjectNameUtf8003, TestSize.Level0)
{
    HcfX509Certificate *x509Cert = nullptr;
    CfEncodingBlob inStream = { 0 };
    inStream.data = reinterpret_cast<uint8_t *>(const_cast<char *>(g_testUtf8CaCert));
    ...
    CfBlob out = { 0 };
    ret = x509Cert->getSubjectNameEx(nullptr, CF_ENCODING_UTF8, &out);
    EXPECT_NE(ret, CF_SUCCESS);
    EXPECT_EQ(out.data, nullptr);
    ...
    ret = x509Cert->getSubjectNameEx(x509Cert, CF_ENCODING_UTF8, nullptr);
    EXPECT_NE(ret, CF_SUCCESS);
    EXPECT_EQ(out.data, nullptr);
    CfBlobDataClearAndFree(&out);
    CfObjDestroy(x509Cert);
...
// spi test Certificate subjectName contains Chinese and special characters.
HWTEST_F(CryptoX509CertificateTest, getSubjectNameUtf8004, TestSize.Level0)
{
    HcfX509CertificateSpi *spiObj = nullptr;
    CfEncodingBlob inStream = { 0 };
    inStream.data = reinterpret_cast<uint8_t *>(const_cast<char *>(g_testUtf8CaCert));
    ...
    CfBlob out = { 0 };
    ret = spiObj->engineGetSubjectNameEx(spiObj, CF_ENCODING_UTF8, &out);
    EXPECT_EQ(ret, CF_SUCCESS);
    EXPECT_NE(out.data, nullptr);
    CfBlobDataClearAndFree(&out);
    CfObjDestroy(spiObj);
...
// spi test Certificate subjectName is null.
HWTEST_F(CryptoX509CertificateTest, getSubjectNameUtf8005, TestSize.Level0)
{
    HcfX509CertificateSpi *spiObj = nullptr;
    CfEncodingBlob inStream = { 0 };
    inStream.data = reinterpret_cast<uint8_t *>(const_cast<char *>(g_testUtf8CaCertNull));
...
// spi test invalid input.
HWTEST_F(CryptoX509CertificateTest, getSubjectNameUtf8006, TestSize.Level0)
{
    HcfX509CertificateSpi *spiObj = nullptr;
    CfEncodingBlob inStream = { 0 };
    inStream.data = reinterpret_cast<uint8_t *>(const_cast<char *>(g_testUtf8CaCertNull));
    ...
    CfBlob out = { 0 };
    ret = spiObj->engineGetSubjectNameEx(nullptr, CF_ENCODING_UTF8, &out);
    EXPECT_NE(ret, CF_SUCCESS);
    EXPECT_EQ(out.data, nullptr);
    ...
    ret = spiObj->engineGetSubjectNameEx(spiObj, CF_ENCODING_UTF8, nullptr);
    EXPECT_NE(ret, CF_SUCCESS);
    EXPECT_EQ(out.data, nullptr);
    CfBlobDataClearAndFree(&out);
    CfObjDestroy(spiObj);
