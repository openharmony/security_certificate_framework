...
#ifndef CF_EXTENSION_ADAPTER_ABILITY_DEFINE_H
#define CF_EXTENSION_ADAPTER_ABILITY_DEFINE_H
...
typedef struct {
    ...
    int32_t (*adapterGetOids)(const CfBase *object, CfExtensionOidType type, CfBlobArray *out);
