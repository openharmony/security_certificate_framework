...
enum ResultCode {
    ...
    ERR_CERT_INVALID_PRIVATE_KEY = 19030008,
    ERR_CERT_UNTRUSTED = 19030009,
    ERR_CERT_REVOKED = 19030010,
    ERR_CERT_UNKNOWN_CRITICAL_EXTENSION = 19030011,
    ERR_CERT_HOST_NAME_MISMATCH = 19030012,
    ERR_CERT_EMAIL_MISMATCH = 19030013,
    ERR_CERT_KEY_USAGE_MISMATCH = 19030014,
    ERR_CRL_NOT_FOUND = 19030015,
    ERR_CRL_NOT_YET_VALID = 19030016,
    ERR_CRL_HAS_EXPIRED = 19030017,
    ERR_CRL_SIGNATURE_FAILURE = 19030018,
    ERR_UNABLE_TO_GET_CRL_ISSUER = 19030019,
...
static const std::unordered_map<CfResult, int> RESULT_CODE = {
    ...
    { CF_ERR_CERT_INVALID_PRIVATE_KEY, ERR_CERT_INVALID_PRIVATE_KEY },
    { CF_ERR_CERT_UNTRUSTED, ERR_CERT_UNTRUSTED },
    { CF_ERR_CERT_REVOKED, ERR_CERT_REVOKED },
    { CF_ERR_CERT_UNKNOWN_CRITICAL_EXTENSION, ERR_CERT_UNKNOWN_CRITICAL_EXTENSION },
    { CF_ERR_CERT_HOST_NAME_MISMATCH, ERR_CERT_HOST_NAME_MISMATCH },
    { CF_ERR_CERT_EMAIL_MISMATCH, ERR_CERT_EMAIL_MISMATCH },
    { CF_ERR_CERT_KEY_USAGE_MISMATCH, ERR_CERT_KEY_USAGE_MISMATCH },
    { CF_ERR_CRL_NOT_FOUND, ERR_CRL_NOT_FOUND },
    { CF_ERR_CRL_NOT_YET_VALID, ERR_CRL_NOT_YET_VALID },
    { CF_ERR_CRL_HAS_EXPIRED, ERR_CRL_HAS_EXPIRED },
    { CF_ERR_CRL_SIGNATURE_FAILURE, ERR_CRL_SIGNATURE_FAILURE },
    { CF_ERR_UNABLE_TO_GET_CRL_ISSUER, ERR_UNABLE_TO_GET_CRL_ISSUER },
    { CF_ERR_OCSP_RESPONSE_NOT_FOUND, ERR_OCSP_RESPONSE_NOT_FOUND },
    { CF_ERR_OCSP_RESPONSE_INVALID, ERR_OCSP_RESPONSE_INVALID },
    { CF_ERR_OCSP_SIGNATURE_FAILURE, ERR_OCSP_SIGNATURE_FAILURE },
    { CF_ERR_OCSP_CERT_STATUS_UNKNOWN, ERR_OCSP_CERT_STATUS_UNKNOWN },
    { CF_ERR_NETWORK_TIMEOUT, ERR_NETWORK_TIMEOUT },
};
} // namespace
